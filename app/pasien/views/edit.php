                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <input type="text" placeholder="Jenis Asuransi" class="form-control" name="asuransi" value="<?= $pasien['asuransi']; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <input type="text" placeholder="Nomor Asuransi" class="form-control" name="no_asuransi" value="<?= $pasien['no_asuransi']; ?>">
                      </div>
                    </div>
                  </div>
